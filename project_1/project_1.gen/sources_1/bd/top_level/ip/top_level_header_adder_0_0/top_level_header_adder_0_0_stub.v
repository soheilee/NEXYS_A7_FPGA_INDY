...
module top_level_header_adder_0_0(clk, resetn, packet_counter, fsm_state, counter, 
  counter_md, axis_in1_tdata, axis_in1_tvalid, axis_in1_tready, axis_in2_tdata, 
  axis_in2_tvalid, axis_in2_tready, axis_in_meta_tdata, axis_in_meta_tvalid, 
  axis_in_meta_tready, axis_out1_tdata, axis_out1_tvalid, axis_out1_tready, 
  axis_out1_tlast, axis_out1_tkeep, axis_out2_tdata, axis_out2_tvalid, axis_out2_tready, 
  axis_out2_tlast, axis_out2_tkeep)
/* synthesis syn_black_box black_box_pad_pin="clk,resetn,packet_counter[128:0],fsm_state[2:0],counter[128:0],counter_md[2:0],axis_in1_tdata[127:0],axis_in1_tvalid,axis_in1_tready,axis_in2_tdata[127:0],axis_in2_tvalid,axis_in2_tready,axis_in_meta_tdata[127:0],axis_in_meta_tvalid,axis_in_meta_tready,axis_out1_tdata[127:0],axis_out1_tvalid,axis_out1_tready,axis_out1_tlast,axis_out1_tkeep[15:0],axis_out2_tdata[127:0],axis_out2_tvalid,axis_out2_tready,axis_out2_tlast,axis_out2_tkeep[15:0]" */;
  input clk;
  input resetn;
