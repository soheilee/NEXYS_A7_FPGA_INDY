...
module top_level_data_switch_0_0(clk, resetn, counter_ps, axis_in_tdata, 
  axis_in_tvalid, axis_in_tready, axis_out1_tdata, axis_out1_tvalid, axis_out1_tready, 
  axis_out2_tdata, axis_out2_tvalid, axis_out2_tready)
/* synthesis syn_black_box black_box_pad_pin="clk,resetn,counter_ps[15:0],axis_in_tdata[127:0],axis_in_tvalid,axis_in_tready,axis_out1_tdata[127:0],axis_out1_tvalid,axis_out1_tready,axis_out2_tdata[127:0],axis_out2_tvalid,axis_out2_tready" */;
  input clk;
  input resetn;
