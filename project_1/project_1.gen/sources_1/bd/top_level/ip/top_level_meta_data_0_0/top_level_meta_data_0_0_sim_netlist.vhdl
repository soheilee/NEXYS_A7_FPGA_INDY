...
entity top_level_meta_data_0_0_meta_data is
  port (
  ...
  attribute ORIG_REF_NAME of top_level_meta_data_0_0_meta_data : entity is "meta_data";
end top_level_meta_data_0_0_meta_data;

architecture STRUCTURE of top_level_meta_data_0_0_meta_data is
  signal \^axis_out_tvalid\ : STD_LOGIC;
  signal axis_out_tvalid_i_1_n_0 : STD_LOGIC;
begin
  axis_out_tvalid <= \^axis_out_tvalid\;
axis_out_tvalid_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F8"
    )
        port map (
...
architecture STRUCTURE of top_level_meta_data_0_0 is
  ...
  attribute X_INTERFACE_PARAMETER of axis_out_tready : signal is "XIL_INTERFACENAME axis_out, TDATA_NUM_BYTES 16, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 0, FREQ_HZ 100000000, PHASE 0.0, CLK_DOMAIN /clk_wiz_clk_out1, LAYERED_METADATA undef, INSERT_VIP 0";
...
inst: entity work.top_level_meta_data_0_0_meta_data
     port map (
      axis_out_tvalid => axis_out_tvalid,
      clk => clk,
      resetn => resetn,
