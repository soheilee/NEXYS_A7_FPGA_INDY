...
module top_level
  ...
  wire ext_reset_in_0_1;
  wire [128:0]header_adder_0_counter;
  wire [2:0]header_adder_0_counter_md;
  ...
  (* CONN_BUS_INFO = "packet_counter_0_axis_out2 xilinx.com:interface:axis:1.0 None TDATA" *) (* DONT_TOUCH *) wire [127:0]packet_counter_0_axis_out2_TDATA;
  (* CONN_BUS_INFO = "packet_counter_0_axis_out2 xilinx.com:interface:axis:1.0 None TKEEP" *) (* DONT_TOUCH *) wire [15:0]packet_counter_0_axis_out2_TKEEP;
  (* CONN_BUS_INFO = "packet_counter_0_axis_out2 xilinx.com:interface:axis:1.0 None TLAST" *) (* DONT_TOUCH *) wire packet_counter_0_axis_out2_TLAST;
  (* CONN_BUS_INFO = "packet_counter_0_axis_out2 xilinx.com:interface:axis:1.0 None TREADY" *) (* DONT_TOUCH *) wire packet_counter_0_axis_out2_TREADY;
  (* CONN_BUS_INFO = "packet_counter_0_axis_out2 xilinx.com:interface:axis:1.0 None TVALID" *) (* DONT_TOUCH *) wire packet_counter_0_axis_out2_TVALID;
  wire [127:0]packet_counter_0_axis_out3_TDATA;
  wire packet_counter_0_axis_out3_TREADY;
  wire packet_counter_0_axis_out3_TVALID;
  ...
  top_level_data_consumer_0_0 data_consumer_0
       (.axis_rx1_tdata(axis_data_fifo_0_M_AXIS_TDATA),
        ...
        .axis_rx2_tdata(packet_counter_0_axis_out2_TDATA),
        .axis_rx2_tkeep(packet_counter_0_axis_out2_TKEEP),
        .axis_rx2_tlast(packet_counter_0_axis_out2_TLAST),
        .axis_rx2_tready(packet_counter_0_axis_out2_TREADY),
        .axis_rx2_tvalid(packet_counter_0_axis_out2_TVALID),
        .clk(clk_wiz_clk_100mhz),
  ...
  top_level_header_adder_0_0 header_adder_0
       (.axis_in1_tdata(packet_counter_0_axis_out1_TDATA),
        ...
        .axis_in2_tdata(packet_counter_0_axis_out3_TDATA),
        .axis_in2_tready(packet_counter_0_axis_out3_TREADY),
        .axis_in2_tvalid(packet_counter_0_axis_out3_TVALID),
        ...
        .axis_out2_tkeep(packet_counter_0_axis_out2_TKEEP),
        .axis_out2_tlast(packet_counter_0_axis_out2_TLAST),
        .axis_out2_tready(packet_counter_0_axis_out2_TREADY),
        .axis_out2_tvalid(packet_counter_0_axis_out2_TVALID),
        .clk(clk_wiz_clk_100mhz),
        .counter(header_adder_0_counter),
        .counter_md(header_adder_0_counter_md),
  ...
  top_level_packet_counter_0_0 packet_counter_0
       (.axis_in1_tdata(data_switch_0_axis_out1_TDATA),
        ...
        .axis_out2_tdata(packet_counter_0_axis_out3_TDATA),
        .axis_out2_tready(packet_counter_0_axis_out3_TREADY),
        .axis_out2_tvalid(packet_counter_0_axis_out3_TVALID),
        .clk(clk_wiz_clk_100mhz),
        .packet_counter(packet_counter_0_packet_counter),
        .resetn(proc_sys_reset_0_peripheral_aresetn));
  ...
  top_level_system_ila_0_2 system_ila_0
       (.SLOT_0_AXIS_tdata(axis_data_fifo_0_M_AXIS_TDATA),
        ...
        .SLOT_1_AXIS_tdata(packet_counter_0_axis_out2_TDATA),
        .SLOT_1_AXIS_tkeep(packet_counter_0_axis_out2_TKEEP),
        .SLOT_1_AXIS_tlast(packet_counter_0_axis_out2_TLAST),
        .SLOT_1_AXIS_tready(packet_counter_0_axis_out2_TREADY),
        .SLOT_1_AXIS_tvalid(packet_counter_0_axis_out2_TVALID),
        .clk(clk_wiz_clk_100mhz),
        .probe0(packet_counter_0_packet_counter),
        .probe1(data_switch_0_counter_ps),
        .probe2(header_adder_0_fsm_state),
        .probe3({1'b0,1'b0,1'b0}),
        .probe4(header_adder_0_counter_md),
        .probe5(header_adder_0_counter),
        .resetn(1'b1));
endmodule
